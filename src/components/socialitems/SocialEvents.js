...
function SocialEvents() {
  ...
  return (
    <>
      {open ? (
        <div className="_social_event_wrapper">
          <div className="_social_event_wrap">
                ...
                <div className="_custom_col_xl_3 _custom_col_lg_3 _custom_col_md_6 _custom_col_sm_12">
                  <div className="_social_event_card_inner">
                    <div
                      ...
                      className="_social_event_btn_link"
                    >
                      <div className="_M_social_event_image_top">
                        <div className="_social_event_image">
                          <img
                            src="../../img/social-event.png"
                            alt=""
                            className="_social_event_img"
                          />
                        </div>
                        <div className="_M_social_event_date_card">
                      ...
                      <h4 className="_social_event_card_inner_title">
                        Event Planning Courses Online Free
                      </h4>
                    </div>
                    ...
                    <div className="_social_event_status_going">
                      <p>
                        <span className="_event_interested">
                          17 People Interested.{" "}
                          <span className="_event_going">16 Going</span>{" "}
                        </span>
                      </p>
                    </div>
                    <div className="_social_event_bottom_grp">
                      <div className="_social_event_bottom_grp_btn">
                        <Button className="_social_event_bottom_grp_btn_link">
                          Going
                        </Button>
                      </div>
                      <div className="_social_event_bottom_grp_btn">
                        <Button className="_social_event_bottom_grp_btn_link1">
                          ...
                          >
                            <path
                              ...
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              d="M13.6 3.1a2.1 2.1 0 11-4.202 0 2.1 2.1 0 014.201 0zM5.2 8A2.1 2.1 0 111 8a2.1 2.1 0 014.2 0v0zM13.6 12.9a2.1 2.1 0 11-4.202 0 2.1 2.1 0 014.201 0zM4.914 9.056l4.781 2.786M9.69 4.156L4.916 6.943"
                            />
                          </svg>
                        </Button>
                      </div>
